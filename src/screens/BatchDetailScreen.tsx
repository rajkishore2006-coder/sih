    ...
    <div className="max-w-3xl mx-auto space-y-4 sm:space-y-5">
        ...
        <div className="flex flex-col sm:flex-row gap-5 items-start sm:items-center justify-between">
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                >
                  {batch.status.toUpperCase()} {batch.latestGrade ? `(${batch.latestGrade})` : ''}
                </span>
              </div>
              ...
              <div className="text-xs text-slate-600 flex items-center gap-2">
                ...
                <span className="font-semibold">{batch.weightQuintals} Quintals</span>
                <span className="text-slate-400">({batch.bagCount} bags)</span>
              </div>
          ...
          <div className="w-full sm:w-auto flex sm:flex-col gap-2 shrink-0">
            <button
              ...
              className="flex-1 sm:flex-initial px-4 py-2.5 rounded-lg bg-[#7C2D12] text-white text-xs font-bold hover:bg-[#68250e] shadow-xs flex items-center justify-center gap-1.5 transition-colors"
            >
              <Camera className="w-4 h-4" />
              <span>Inspect Heap</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <h3 className="text-sm font-bold text-slate-800 flex items-center gap-2">
          ...
          <span>Inspection & Certification History ({inspections.length})</span>
        </h3>
              ...
              >
                <div className="space-y-1">
                  ...
                  <div className="text-xs text-slate-600">
                    Inspector: <span className="font-semibold">{insp.inspectorName}</span> ({insp.inspectorId})
                  </div>
                  ...
                  <div className="text-[11px] text-slate-400 flex items-center gap-2">
                    ...
                    <span>•</span>
                    <span>Sample: {insp.sampleWeightKg} kg</span>
                  </div>
